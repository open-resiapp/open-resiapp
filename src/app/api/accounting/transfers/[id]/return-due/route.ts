...
import { handleSetReturnDue } from "@modules/accounting/src/routes/api/okruh-transfers";

type Ctx = { params: Promise<{ id: string }> };

export const POST = withModuleEnabled(
  "accounting",
  async (req: NextRequest, ctx: Ctx) => handleSetReturnDue(req, (await ctx.params).id)
);
